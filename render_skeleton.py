...
라벨링 규약 v1.2: 마커=체크 크기만 / 서명줄=이름(text)+문구(signature) 분리.
  python render_skeleton.py <골격.json ...> --out runs/render_check
"""
...
class R:
    ...
    def html(self):
        ...
        PF_ALLOW={"pf_filled":{"기록지","명세신고","보고서","접수증"},"pf_note":{"판단서","통지회신","조회요청서","점검평가"},
                  "pf_example":{"사정조사지","기록지","점검평가"},"pf_label":{"안내문","신청서","동의서"},
                  "pf_italic":{"점검평가","기록지","사정조사지"}}
