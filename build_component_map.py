...
<ol>
<li><b>필드 pool</b> (pattern/pool.json 배정 79키) — 물리 계열×기제로 정규화된 변형 전수.</li>
...
def build():
    ...
    out = "runs/component_map/index.html"
    import os; os.makedirs("runs/component_map", exist_ok=True)
