...
## 2차 조사 — 변동 폭 방법론 (2026-09-11)

4차 학습 후 "합성 분포를 외웠다"는 진단(8_train/docs/DECISIONS.md 13)에 따라 네 에이전트가 도메인 무작위화·문서 합성 다양성·학습 증강·측정/혼합을 독립 조사. 원문과 교차 검증은 [`variation/README.md`](variation/README.md). 결론 요약: 판정은 실서식만으로, 폭 > 사실성 > 수량, 모든 축 연속화·글꼴 ≥30·실코퍼스 어휘·방해물, 실 100장 미세조정, 44장 CI ±3~4pt 라 앵커 확장이 전제.
