"""복제 HTML → PNG + GT. 사용: ./venv/bin/python render_html.py runs/replica_html/*.html --out DIR"""
...
if __name__=="__main__":
    ...
    out=sys.argv[sys.argv.index("--out")+1] if "--out" in sys.argv else "runs/replica_render"
