...
| **채택 · ft_full_v4syn (v4 합성 수렴 6 epoch → 실서식 105장 full 미세조정 15 epoch 고정 · last.pt)** | **`runs/ft_full_v4syn/weights/last.pt`** | 합성 val mAP50-95 0.846(베이스) | **96.41 [92.3, 98.6]** (평가분 52장, 4차 e1 대비 +2.55 [+0.9, +4.1], max_det 1000) · 좌표 99.16 · 종류 99.51 | **98.36** (v4 stress) | `docs/PLAN.md` 10.11 |
