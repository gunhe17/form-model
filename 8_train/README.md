...
| 5차-ft (4차 e1 + 실서식 105장 미세조정 full 1e-4 · 15 epoch 고정 · last.pt) | `runs/ft_full_v3e1/weights/last.pt` | — | 94.27 [89.9, 97.9] (평가분 52장, 기준선 대비 +2.18 [+1.1, +3.2]) | 95.65 | `docs/PLAN.md` 10.7 |
| **채택 · ft_full_v4syn (v4 합성 수렴 6 epoch → 실서식 105장 full 미세조정 15 epoch 고정 · last.pt)** | **`runs/ft_full_v4syn/weights/last.pt`** | 합성 val mAP50-95 0.846(베이스) | **94.20 [89.6, 97.9]** (평가분 52장, 기준선 대비 +2.11 [+0.8, +3.2]) · 좌표 99.14 · 종류 99.49 | **98.36** | `docs/PLAN.md` 10.9 |
