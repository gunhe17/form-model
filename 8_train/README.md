...
| **최종 채택 · ft_v5e (v5syn 재수렴 베이스 → 실서식 105장 full 미세조정, 리플레이 822+x3×3+x4×1+x6×1+x7×1 = 39.1%)** | **`runs/ft_v5e/weights/last.pt`** | 베이스 합성 val mAP50-95 0.848 | **98.26 ✓** (평가분 52장) · 좌표 **99.70 ✓** · 종류 **99.51 ✓** | **98.51 ✓** (v4 stress) | `docs/PLAN.md` 10.21 · **4축 전부 통과** |
