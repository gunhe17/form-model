...
| **채택 · ft_full_v4syn_x34b (위 + 리플레이에 세로괘선없는 표 x3 ×3·초장문 gap x4 ×2, 36.6%)** | **`runs/ft_full_v4syn_x34b/weights/last.pt`** | — | **98.26 [97.1, 99.0]** (평가분 52장, 구 채택 대비 +1.85 [+0.1, +5.7]) · 좌표 99.40 · 종류 99.36 · **실서식 기준 98 첫 통과** | 97.88 (v4 stress, −0.12) | `docs/PLAN.md` 10.15 |
